...
async def get_apps(request: Request, current_user: str = Depends(require_authentication)):
    ...
    try:
        ...
        for app in all_apps:
            try:
                ...
                app_info = {
                    ...
                    "is_connected": session_store.has_session(current_user, app_slug) if hasattr(session_store, 'has_session') else False,
                    "tools_count": 0
                }
        ...
        raise HTTPException(
            status_code=500,
            detail="An unexpected error occurred while fetching apps"
        )
